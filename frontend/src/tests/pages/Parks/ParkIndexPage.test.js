...
describe("ParkIndexPage tests", () => {
    ...
    test("renders empty table when backend unavailable, user only", async () => {
        ...
        expect(errorMessage).toMatch("Error communicating with backend via GET on /api/parks/all");
        restoreConsole();
    ...
    test("what happens when you click delete, admin", async () => {
        ...
        await waitFor(() => { expect(mockToast).toBeCalledWith("Park with id 2 was deleted") });
